...
|:--------------|---------------|:--------------|---------------|---------------|:-------------:|
|[Risco de Crédito](https://github.com/GuilhermeSecco/Risco-de-Credito)|Este projeto tem como objetivo avaliar o risco de crédito e prever a probabilidade de fraude em empréstimos utilizando Machine Learning.|<img width="962" height="550" alt="image" src="https://github.com/user-attachments/assets/44dfaa94-6cc2-463a-bf3d-a811450cf10f" />|A Probabilidade de Fraude aumenta conforme o saldo devedor aumenta e o Total Pago diminui|Random Forest Alcançou 98% de Precisão|Excel<br>Pandas<br>NumPy<br>Scikit-Learn<br>|
