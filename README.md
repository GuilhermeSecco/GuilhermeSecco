...
|[Recomendação de Filmes](https://github.com/GuilhermeSecco/Sistema-Recomendacao-Filmes)|Implementei um sistema de recomendação de filmes utilizando o algoritmo K-Nearest Neighbors (KNN)|Treinado a partir de dados públicos do MovieLens e do dataset movies_metadata do TMDB.|KNN é surpreendente bom para recomendações de filmes pois considera os vizinhos mais próximos para a tomada de decisões|O modelo recomenda filmes semelhantes e acaba sendo bem preciso|Numpy<br>Pandas<br>Scikit-learn<br>Scipy|
