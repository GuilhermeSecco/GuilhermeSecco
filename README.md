...
|:--------------|---------------|:--------------|---------------|---------------|:-------------:|
|[Risco de Crédito](https://github.com/GuilhermeSecco/Risco-de-Credito)|O medelo é capaz de extraior os dados de um banco de dados MySQL para avaliar o risco de crédito e prever a probabilidade de fraude em empréstimos utilizando Machine Learning.|<img width="962" height="550" alt="image" src="https://github.com/user-attachments/assets/44dfaa94-6cc2-463a-bf3d-a811450cf10f" />|A Probabilidade de Fraude aumenta conforme o saldo devedor aumenta e o Total Pago diminui|Random Forest Alcançou 98% de Precisão durante o treino.|Excel<br>MySQL<br>Pandas<br>NumPy<br>Scikit-Learn<br>|
