...
- 👔 Procurando estágio em ciência de dados ou junior em analise de dados.
- 🎓 Atualmente estudando: Modelos de Machine Learning, Matemática e Estatística.
- 📖 [Meus Estudos.](https://github.com/GuilhermeSecco/Estudos)

## Projetos de Ciência de Dados
|📋Projeto|📃Resumo do Projeto|📊Gráficos|💡Insight|📐Métricas|⚡Tecnologias
|:--------------|---------------|:--------------|---------------|---------------|:-------------:|
|[Risco de Crédito](https://github.com/GuilhermeSecco/Risco-de-Credito)|O medelo é capaz de extraior os dados de um banco de dados MySQL para avaliar o risco de crédito e prever a probabilidade de fraude em empréstimos utilizando Machine Learning.|<img width="962" height="550" alt="image" src="https://github.com/user-attachments/assets/44dfaa94-6cc2-463a-bf3d-a811450cf10f" />|A Probabilidade de Fraude aumenta conforme o saldo devedor aumenta e o Total Pago diminui|Random Forest Alcançou 98% de Precisão|Excel<br>MySQL<br>Pandas<br>NumPy<br>Scikit-Learn<br>|
|[Previsão de Compras Online](https://github.com/GuilhermeSecco/Previsao-de-vendas)|Treinei modelos SVM com diferentes kernels para prever se uma compra online será efetuada, usando técnicas de pré-processamento, balanceamento (SMOTE) e ajuste de hiperparâmetros.|<img width="3000" height="1800" alt="comparacao_modelos_svm" src="https://github.com/user-attachments/assets/c41de12f-2fde-44bd-8f4d-c92ef6b1d4f1" />|O kernel RBF apresentou o melhor desempenho geral, mas o kernel linear padronizado também teve bons resultados com menor custo computacional.|Precisão (melhor modelo - RBF): 94.87%<br>AUC: 95.10%|Pandas<br>NumPy<br>Matplotlib<br>Seaborn<br>Scikit-Learn<br>Imbalanced-Learn|
|[Recomendação de Filmes](https://github.com/GuilhermeSecco/Sistema-Recomendacao-Filmes)|Implementei um sistema de recomendação de filmes utilizando o algoritmo K-Nearest Neighbors (KNN)|<img width="2400" height="1500" alt="top_recomendacoes_alien" src="https://github.com/user-attachments/assets/cea5a822-ab9a-45b0-9c81-34fe90cfd939" />|KNN é surpreendente bom para recomendações de filmes pois considera os vizinhos mais próximos para a tomada de decisões|Utilizei o Streamlit para criar um site interativo para melhor demonstração do projeto<br>Link: https://recomendacao-filmes.streamlit.app/|Git<br>Numpy<br>Pandas<br>Scipy<br>Scikit-learn<br>Streamlit|
